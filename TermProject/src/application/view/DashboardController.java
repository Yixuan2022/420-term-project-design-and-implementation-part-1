...
public class DashboardController {
    ...
    @FXML
    private Button itemVisitButton;
	...
	public void scanFarmDrone() {
		...
		Timeline moveDiagonal7  = addTimeLine(-homeValueX+400, 720,     -homeValueX+600,   720, endDuration1);
		Timeline moveDiagonal8  = addTimeLine(-homeValueX+600, 720,     -homeValueX+600,   0,   endDuration3);

		Timeline moveDiagonal9  = addTimeLine(-homeValueX+600, 0,       -homeValueX+800,   0,   endDuration1);
		Timeline moveDiagonal10 = addTimeLine(-homeValueX+800, 0,       -homeValueX+800,   720, endDuration3);
		Timeline moveDiagonal11 = addTimeLine(-homeValueX+800, 720,     -homeValueX+900,   720,   endDuration1);
		Timeline moveDiagonal12 = addTimeLine(-homeValueX+900, 720,     -homeValueX+900,   0,   endDuration3);
		Timeline moveDiagonal13 = addTimeLine(-homeValueX+900, 0,       0,                0,       endDuration1);
		...
		sequence.getChildren().addAll(
				...
				moveDiagonal8, moveDiagonal9, moveDiagonal10, moveDiagonal11, moveDiagonal12, moveDiagonal13
		        );
		sequence.play();
		sequence.setCycleCount(Timeline.INDEFINITE);
	}
